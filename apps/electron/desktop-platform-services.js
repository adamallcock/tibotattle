...
/**
 * Main-process-only adapters for native desktop capabilities. All open targets
 * are fixed constants and the native folder picker returns only a canonical,
 * validated directory; renderer input is never interpreted as a URL or path.
 */
