...
// Desktop ownership SHA-256: 3a94b2b5a9895b7ffed8c7d00da2c3e775f438eec00fda6e8fdb573d7867f4e9

const DESKTOP_SHARED_MESSAGES = Object.freeze({
  ...
  "electron.settings.login.status.unavailable": Object.freeze({
    "en-US": "Start at login status is unavailable on this system.",
    "zh-Hans": "此系统无法确认登录时启动状态。",
    "es": "El estado del inicio de sesión no está disponible en este sistema.",
  }),
  ...
  "electron.tray.customize": Object.freeze({
    "en-US": "Customize tray…",
    "zh-Hans": "自定义托盘…",
    "es": "Personalizar bandeja…",
  }),
  "electron.tray.dualMeterHint": Object.freeze({
    "en-US": "Top: 5-hour allowance. Bottom: 7-day allowance.",
    "zh-Hans": "上方：5 小时额度。下方：7 天额度。",
    "es": "Arriba: límite de 5 horas. Abajo: límite de 7 días.",
  }),
  "electron.tray.low": Object.freeze({
    "en-US": "{window}: 10% remaining or less",
    "zh-Hans": "{window}：剩余量不超过 10%",
    "es": "{window}: queda un 10% o menos",
  }),
  ...
  "electron.tray.resetClock": Object.freeze({
    "en-US": "{window} resets at {reset}",
    "zh-Hans": "{window}于 {reset} 重置",
    "es": "{window} reinicia a las {reset}",
  }),
  "electron.tray.resetCountdown": Object.freeze({
    "en-US": "{window} resets in {reset}",
    "zh-Hans": "{window}在 {reset} 后重置",
    "es": "{window} reinicia en {reset}",
  }),
  ...
  "electron.tray.selectedUnavailable": Object.freeze({
    "en-US": "{window} unavailable",
    "zh-Hans": "{window}不可用",
    "es": "{window} no disponible",
  }),
...
const DESKTOP_OVERLAY_MESSAGES = Object.freeze({
...
const DESKTOP_OVERRIDES = Object.freeze({
...
const DESKTOP_DEFAULT_LOCALE = "en-US";
