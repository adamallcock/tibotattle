...
export const WEB_MESSAGES = Object.freeze({
  ...
  "accounting.pricing.thirtyDayCoverageWarning": ["30-day coverage includes usage changes before reviewed historical prices began{date}. Read the percentage as partial historical coverage.", "30 天覆盖范围包含经审核历史价格开始之前的使用变化{date}。请将该百分比视为部分历史覆盖率。", "La cobertura de 30 días incluye cambios de uso anteriores al inicio de los precios históricos revisados{date}. Interpreta el porcentaje como cobertura histórica parcial."],
 ...
 "accounting.pricing.coverageReviewed": ["All usage changes in this period have reviewed pricing.", "此期间的所有使用变化都有经审核的价格。", "Todos los cambios de uso de este período tienen precios revisados."],
  ...
  "share.footer": ["Local usage · API equivalent, not a bill.", "本地使用 · API 等价值，不是账单。", "Uso local · equivalente de API, no una factura."],
...
export const LEGACY_TEXT_CATALOG = Object.freeze({
  ...
  "Coverage and price provenance remain visible above; unavailable evidence never adds an invented cost.": ["覆盖范围和价格来源保留在上方可见；不可用的证据绝不会添加虚构成本。", "La cobertura y la procedencia de los precios siguen visibles arriba; la evidencia no disponible nunca añade un coste inventado."],
  "Delayed community evidence is published on the public website.": ["延迟社区证据发布在公共网站上。", "La evidencia comunitaria diferida se publica en el sitio web público."],
  "View delayed community evidence": ["查看延迟社区证据", "Ver evidencia comunitaria diferida"],
  ...
  "Preparation and inspection stay on this Mac. Send is a separate, explicit action after the concise review is ready.": ["准备和检查保留在这台 Mac 上。简要审阅完成后，发送仍是单独且明确的操作。", "La preparación y la inspección permanecen en este Mac. El envío es una acción independiente y explícita después de completar la revisión breve."],
  "Prepare local evidence": ["准备本地证据", "Preparar evidencia local"],
  "Nothing is sent until you separately inspect and choose a send action.": ["在你单独检查并选择发送操作之前，不会发送任何内容。", "No se envía nada hasta que lo inspecciones por separado y elijas una acción de envío."],
  "Reviewed contribution": ["已审阅的贡献", "Contribución revisada"],
  "Review prepared summary": ["审阅已准备的摘要", "Revisar el resumen preparado"],
  "Send reviewed summary": ["发送已审阅的摘要", "Enviar el resumen revisado"],
  "Sending stays disabled until the current prepared set has been inspected locally.": ["在当前准备集完成本地检查之前，发送将保持禁用。", "El envío permanece desactivado hasta que el conjunto preparado actual se haya inspeccionado localmente."],
