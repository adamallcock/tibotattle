...
export const WEB_MESSAGES = Object.freeze({
  ...
  "dashboard.stale.observationTitle": ["Observations need an update", "观测数据需要更新", "Las observaciones necesitan actualizarse"],
  "dashboard.stale.observationCopy": ["Showing the last recorded allowance. Update local usage for a newer observation.", "显示最近记录的额度。更新本地使用量以获取更新的观测数据。", "Se muestra la última asignación registrada. Actualiza el uso local para obtener una observación más reciente."],
