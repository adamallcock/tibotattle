...
export const LEGACY_TEXT_CATALOG = Object.freeze({
  ...
  "Improve community estimates with one reviewed, content-free result. You see the exact prepared export before anything is sent.": ["用一份经过审核且不含内容的结果改进社区估算。在发送任何内容前，你可以查看确切的准备导出。", "Mejora las estimaciones comunitarias con un resultado revisado y sin contenido. Ves la exportación preparada exacta antes de que se envíe nada."],
  ...
  "Signing out revokes this browser's service session and forgets this sign-in. It deletes nothing: metadata already contributed stays until you delete it in Hosted privacy controls.": ["退出登录会撤销此浏览器的服务会话并忘记这次登录。它不会删除任何内容：已经贡献的元数据会一直保留，直到你在“托管隐私控制”中删除它。", "Cerrar sesión revoca la sesión de servicio de este navegador y olvida este inicio de sesión. No elimina nada: los metadatos ya aportados permanecen hasta que los elimines en Controles de privacidad alojados."],
  "This browser already has a service session. Signing out revokes it; it deletes nothing, and metadata already contributed stays until you delete it in Hosted privacy controls.": ["此浏览器已有服务会话。退出登录会撤销该会话；它不会删除任何内容，已经贡献的元数据会一直保留，直到你在“托管隐私控制”中删除它。", "Este navegador ya tiene una sesión de servicio. Cerrar sesión la revoca; no elimina nada y los metadatos ya aportados permanecen hasta que los elimines en Controles de privacidad alojados."],
