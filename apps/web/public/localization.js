...
export const WEB_MESSAGES = Object.freeze({
  ...
  "electron.tray.refresh": ["Refresh Usage", "刷新使用情况", "Actualizar uso"],
  ...
  "electron.tray.quit": ["Quit", "退出", "Salir"],
 ...
 "accounting.pricing.coverageReviewed": ["All usage changes in this period have reviewed pricing.", "此期间的所有使用变化都有经审核的价格。", "Todos los cambios de uso de este período tienen precios revisados."],
  ...
  "localAnalysis.progress.analyzingFiles": ["Analyzing {processed}/{selected} files…", "正在分析 {processed}/{selected} 个文件…", "Analizando {processed}/{selected} archivos…"],
  "localAnalysis.progress.analyzingEvidence": ["Analyzing local evidence…", "正在分析本地证据…", "Analizando la evidencia local…"],
