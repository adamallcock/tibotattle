...
export const WEB_MESSAGES = Object.freeze({
 ...
 "accounting.pricing.coverageReviewed": ["All usage changes in this period have reviewed pricing.", "此期间的所有使用变化都有经审核的价格。", "Todos los cambios de uso de este período tienen precios revisados."],
  ...
  "chart.resetEvents.legend": ["Reset events", "重置事件", "Eventos de restablecimiento"],
  "chart.resetEvent.scheduledReset": ["Scheduled reset", "计划重置", "Restablecimiento programado"],
  "chart.resetEvent.bankedResetUsed": ["Banked reset used", "已使用储存的重置", "Restablecimiento guardado usado"],
  "chart.resetEvent.unknownReset": ["Reset type unknown", "重置类型未知", "Tipo de restablecimiento desconocido"],
  "chart.resetEvent.creditGranted": ["Reset credit received", "已收到重置额度", "Crédito de restablecimiento recibido"],
  "chart.resetEvent.creditExpired": ["Reset credit expired", "重置额度已过期", "Crédito de restablecimiento caducado"],
  "chart.resetEvent.providerTime": ["Provider timestamp · {time}", "提供方时间戳 · {time}", "Marca de tiempo del proveedor · {time}"],
  "chart.resetEvent.observedBetween": ["Observed between {start} and {end}", "观测区间：{start} 至 {end}", "Observado entre {start} y {end}"],
