...
export const WEB_MESSAGES = Object.freeze({
  ...
  "accounting.pricing.evidenceStarts": ["Reviewed historical prices start {date}; earlier events stay unpriced.", "经审核的历史价格始于 {date}；更早的事件保持未定价。", "Los precios históricos revisados comienzan el {date}; los eventos anteriores permanecen sin precio."],
...
export const LEGACY_TEXT_CATALOG = Object.freeze({
  ...
  "Signing out ends this browser's contribution session.": ["退出登录会结束此浏览器的贡献会话。", "Cerrar sesión finaliza la sesión de contribución de este navegador."],
  "This browser already has a contribution session. Signing out ends it.": ["此浏览器已有贡献会话。退出登录会结束该会话。", "Este navegador ya tiene una sesión de contribución. Cerrar sesión la finaliza."],
  ...
  "Automatic contribution is off.": ["自动贡献已关闭。", "La contribución automática está desactivada."],
