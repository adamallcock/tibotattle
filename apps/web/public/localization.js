...
export const WEB_MESSAGES = Object.freeze({
 ...
 "accounting.pricing.coverageReviewed": ["All usage changes in this period have reviewed pricing.", "此期间的所有使用变化都有经审核的价格。", "Todos los cambios de uso de este período tienen precios revisados."],
  ...
  "community.allowance.planMethod": ["Scaled to Pro 20×: Pro 20× ×1, Pro 5× ×4, Plus ×20—not each plan’s actual allowance. Shading: middle 80% of qualifying reset fits. Missing days stay gaps.", "换算为 Pro 20×：Pro 20× 乘以 1，Pro 5× 乘以 4，Plus 乘以 20，并非各方案实际额度。阴影为合格重置拟合的中间 80%。缺失日期保持为空缺。", "Escalado a Pro 20×: Pro 20× ×1, Pro 5× ×4, Plus ×20; no es la asignación real de cada plan. Sombreado: 80% central de ajustes válidos. Los días sin datos quedan vacíos."],
