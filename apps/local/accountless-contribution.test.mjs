...
test("companion accountless mode is absent without the laboratory configuration", () => {
  ...
  ]) assert.throws(() => createLocalAccountlessContribution({ environment }), /Invalid accountless laboratory configuration/u);
});

test("companion composes saved preference, private credential port and one bounded runner", async () => {
