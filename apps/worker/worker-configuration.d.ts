/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 676019885c32b150a13e1ae26e3b0d21)
...
interface __BaseEnv_Env {
	...
	ENROLLMENT_RATE_LIMIT: RateLimit;
	RECOVERY_RATE_LIMIT: RateLimit;
	CLIENT_ATTEMPT_RATE_LIMIT: RateLimit;
	PUBLIC_READ_RATE_LIMIT: RateLimit;
	UPLOAD_AUTHORIZATION_RATE_LIMIT: RateLimit;
	UPLOAD_PRINCIPAL_RATE_LIMIT: RateLimit;
	UPLOAD_INGRESS_REQUEST_RATE_LIMIT: RateLimit;
	UPLOAD_INGRESS_CLIENT_RATE_LIMIT: RateLimit;
	ASSETS: Fetcher;
	ENVIRONMENT: "staging" | "production" | "synthetic-development";
	ENROLLMENT_MODE: "disabled" | "open" | "local_open";
	ACCOUNTLESS_ENROLLMENT_MODE?: "disabled" | "enabled";
	ACCOUNTLESS_OWNERSHIP_MODE?: "disabled" | "enabled";
	ACCOUNT_SCOPED_INGEST_MODE: "disabled";
	TELEMETRY_STORAGE_MODE: "json";
	TELEMETRY_STORAGE_NAMESPACE: "";
	UPLOAD_INGRESS_QUEUE_MODE: "disabled";
	UPLOAD_INGRESS_MAX_CONCURRENT: "8" | "64";
	UPLOAD_INGRESS_MAX_STARTS_PER_MINUTE: "120" | "1200";
	UPLOAD_INGRESS_BURST: "16" | "1200";
	UPLOAD_INGRESS_LEASE_SECONDS: "90";
	UPLOAD_INGRESS_BODY_TOTAL_SECONDS: "60";
	UPLOAD_INGRESS_BODY_IDLE_SECONDS: "15";
	SIGN_IN_START_MAX_PER_MINUTE: "5" | "300" | "1200";
	IDENTITY_LINK_SECRET_VERSION?: "staging-v1" | "production-v1";
	PUBLIC_ORIGIN?: "https://app-usagemonitor-staging.adamallcock.workers.dev" | "https://tibotattle.com";
	ENVELOPE_PRIVATE_JWK: string;
	ENVELOPE_PUBLIC_JWK: string;
	IDENTITY_LINK_SECRET?: string;
	UPLOAD_INGRESS_BUDGET: DurableObjectNamespace<import("./src/index").UploadIngressBudget>;
	SPARKLE_RELEASES?: R2Bucket;
	...
	STORAGE_ROUTING_MODE?: "single";
	STORAGE_CAPACITY_MODE?: "disabled";
	STORAGE_ANALYTICS_MODE?: "disabled";
	STORAGE_SOURCE_NAMESPACE_A?: "synthetic-a";
	STORAGE_SOURCE_NAMESPACE_B?: "synthetic-b";
	STORAGE_SOURCE_NAMESPACE_C?: "synthetic-c";
	STORAGE_NEW_OWNER_RESERVATION_BYTES?: "16777216";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UploadIngressBudget";
	}
	interface StagingEnv {
		...
		PUBLIC_ORIGIN: "https://app-usagemonitor-staging.adamallcock.workers.dev";
		ENVELOPE_PRIVATE_JWK: string;
		ENVELOPE_PUBLIC_JWK: string;
		IDENTITY_LINK_SECRET: string;
		UPLOAD_INGRESS_BUDGET: DurableObjectNamespace<import("./src/index").UploadIngressBudget>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ENROLLMENT_MODE" | "ACCOUNTLESS_ENROLLMENT_MODE" | "ACCOUNTLESS_OWNERSHIP_MODE" | "ACCOUNT_SCOPED_INGEST_MODE" | "TELEMETRY_STORAGE_MODE" | "TELEMETRY_STORAGE_NAMESPACE" | "UPLOAD_INGRESS_QUEUE_MODE" | "UPLOAD_INGRESS_MAX_CONCURRENT" | "UPLOAD_INGRESS_MAX_STARTS_PER_MINUTE" | "UPLOAD_INGRESS_BURST" | "UPLOAD_INGRESS_LEASE_SECONDS" | "UPLOAD_INGRESS_BODY_TOTAL_SECONDS" | "UPLOAD_INGRESS_BODY_IDLE_SECONDS" | "SIGN_IN_START_MAX_PER_MINUTE" | "IDENTITY_LINK_SECRET_VERSION" | "PUBLIC_ORIGIN" | "ENVELOPE_PRIVATE_JWK" | "ENVELOPE_PUBLIC_JWK" | "IDENTITY_LINK_SECRET" | "ALLOWANCE_RECONSTRUCTION_MODE" | "INCREMENTAL_EXTERNAL_PARTICIPANTS" | "GOOGLE_OIDC_CLIENT_ID" | "APPLE_SERVICES_ID" | "APPLE_KEY_ID" | "APPLE_TEAM_ID" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "ACCESS_ADMIN_EMAIL" | "DISTRIBUTION_ANALYTICS_ZONE_ID" | "SPARKLE_APPCAST_GUARD_MODE" | "SPARKLE_APPCAST_GUARD_CHANNEL" | "SPARKLE_APPCAST_GUARD_BUCKET" | "SPARKLE_APPCAST_GUARD_APPCAST_KEY" | "SPARKLE_APPCAST_GUARD_ENDPOINT_PATH" | "SPARKLE_APPCAST_GUARD_CONTENT_TYPE" | "SPARKLE_APPCAST_GUARD_CACHE_CONTROL" | "SPARKLE_APPCAST_GUARD_MAX_XML_BYTES" | "SPARKLE_APPCAST_GUARD_PUBLIC_ED_KEY" | "SPARKLE_APPCAST_GUARD_PUBLIC_ED_KEY_SHA256" | "APPLE_PRIVATE_KEY" | "GOOGLE_OIDC_CLIENT_SECRET" | "STORAGE_ROUTING_MODE" | "STORAGE_CAPACITY_MODE" | "STORAGE_ANALYTICS_MODE" | "STORAGE_SOURCE_NAMESPACE_A" | "STORAGE_SOURCE_NAMESPACE_B" | "STORAGE_SOURCE_NAMESPACE_C" | "STORAGE_NEW_OWNER_RESERVATION_BYTES">> {}
}
