/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 9c5408465dabe39f6c68ddde6fbce1ed)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ENROLLMENT_MODE" | "ACCOUNT_SCOPED_INGEST_MODE" | "ENVELOPE_PRIVATE_JWK" | "ENVELOPE_PUBLIC_JWK" | "GOOGLE_OIDC_CLIENT_ID" | "APPLE_SERVICES_ID" | "APPLE_KEY_ID" | "APPLE_TEAM_ID" | "APPLE_DOMAIN_ASSOCIATION" | "IDENTITY_LINK_SECRET" | "APPLE_PRIVATE_KEY" | "GOOGLE_OIDC_CLIENT_SECRET">> {}
}
