...
CREATE TABLE participants_0058_save AS SELECT id, access_token_id, access_token_hash, recovery_token_id, recovery_token_hash, state, consent_version, consented_at, created_at, deletion_session_id, identity_link_key, identity_cooldown_digest FROM participants;
CREATE TABLE attribution_enrollments_0058_save AS SELECT * FROM attribution_enrollments;
CREATE TABLE community_aggregate_exclusions_0058_save AS SELECT * FROM community_aggregate_exclusions;
CREATE TABLE community_allowance_fit_cache_0058_save AS SELECT * FROM community_allowance_fit_cache;
CREATE TABLE community_analytical_input_versions_0058_save AS SELECT * FROM community_analytical_input_versions;
CREATE TABLE community_model_composition_cache_0058_save AS SELECT * FROM community_model_composition_cache;
CREATE TABLE contributions_0058_save AS SELECT * FROM contributions;
CREATE TABLE device_credential_rotations_0058_save AS SELECT * FROM device_credential_rotations;
CREATE TABLE device_credentials_0058_save AS SELECT id, participant_id, paired_via_pairing_id, secret_hash, state, issued_at, expires_at, last_used_at, revoked_at, social_verified_at, credential_generation FROM device_credentials;
CREATE TABLE device_pairing_events_0058_save AS SELECT * FROM device_pairing_events;
CREATE TABLE device_pairings_0058_save AS SELECT * FROM device_pairings;
CREATE TABLE device_upload_authorizations_0058_save AS SELECT * FROM device_upload_authorizations;
CREATE TABLE enrollment_grants_0058_save AS SELECT * FROM enrollment_grants;
CREATE TABLE participant_community_eligibility_0058_save AS SELECT * FROM participant_community_eligibility;
CREATE TABLE recovery_retry_receipts_0058_save AS SELECT * FROM recovery_retry_receipts;
CREATE TABLE telemetry_contribution_admission_windows_0058_save AS SELECT * FROM telemetry_contribution_admission_windows;
CREATE TABLE telemetry_contribution_occurrences_0058_save AS SELECT * FROM telemetry_contribution_occurrences;
CREATE TABLE telemetry_contributions_0058_save AS SELECT * FROM telemetry_contributions;
CREATE TABLE telemetry_records_0058_save AS SELECT * FROM telemetry_records;
CREATE TABLE telemetry_transport_floor_rollbacks_0058_save AS SELECT * FROM telemetry_transport_floor_rollbacks;
CREATE TABLE telemetry_transport_participant_floors_0058_save AS SELECT * FROM telemetry_transport_participant_floors;
CREATE TABLE telemetry_v11_chunks_0058_save AS SELECT * FROM telemetry_v11_chunks;
CREATE TABLE telemetry_v11_day_manifests_0058_save AS SELECT * FROM telemetry_v11_day_manifests;
CREATE TABLE telemetry_v11_device_consents_0058_save AS SELECT * FROM telemetry_v11_device_consents;
CREATE TABLE telemetry_v11_domain_days_0058_save AS SELECT * FROM telemetry_v11_domain_days;
CREATE TABLE telemetry_v11_domain_heads_0058_save AS SELECT * FROM telemetry_v11_domain_heads;
CREATE TABLE telemetry_v11_domain_predecessors_0058_save AS SELECT * FROM telemetry_v11_domain_predecessors;
CREATE TABLE telemetry_v11_domains_0058_save AS SELECT * FROM telemetry_v11_domains;
CREATE TABLE telemetry_v11_records_0058_save AS SELECT * FROM telemetry_v11_records;
CREATE TABLE telemetry_v1_chunk_admission_windows_0058_save AS SELECT * FROM telemetry_v1_chunk_admission_windows;
CREATE TABLE telemetry_v1_chunks_0058_save AS SELECT * FROM telemetry_v1_chunks;
CREATE TABLE telemetry_v1_device_consents_0058_save AS SELECT * FROM telemetry_v1_device_consents;
CREATE TABLE telemetry_v1_records_0058_save AS SELECT * FROM telemetry_v1_records;
CREATE TABLE upload_authorizations_0058_save AS SELECT * FROM upload_authorizations;
CREATE TABLE web_sessions_0058_save AS SELECT * FROM web_sessions;
CREATE TABLE community_analysis_work_0058_save AS SELECT * FROM community_analysis_work;
CREATE TABLE community_analysis_work_parts_0058_save AS SELECT * FROM community_analysis_work_parts;
CREATE TABLE community_analysis_work_stage_0058_save AS SELECT * FROM community_analysis_work_stage;
CREATE TABLE community_current_analysis_queue_0058_save AS SELECT * FROM community_current_analysis_queue;
CREATE TABLE community_graph_update_scope_0058_save AS SELECT * FROM community_graph_update_scope;
CREATE TABLE community_model_history_dependencies_0058_save AS SELECT * FROM community_model_history_dependencies;
CREATE TABLE community_model_history_results_0058_save AS SELECT * FROM community_model_history_results;
CREATE TABLE community_model_history_work_0058_save AS SELECT * FROM community_model_history_work;
CREATE TABLE community_model_history_work_parts_0058_save AS SELECT * FROM community_model_history_work_parts;
CREATE TABLE community_model_history_work_stage_0058_save AS SELECT * FROM community_model_history_work_stage;
CREATE TABLE community_prepared_fit_rows_0058_save AS SELECT * FROM community_prepared_fit_rows;
CREATE TABLE community_prepared_plan_rows_0058_save AS SELECT * FROM community_prepared_plan_rows;
CREATE TABLE community_prepared_source_days_0058_save AS SELECT * FROM community_prepared_source_days;
CREATE TABLE community_prepared_usage_bins_0058_save AS SELECT * FROM community_prepared_usage_bins;
CREATE TABLE community_prepared_usage_rows_0058_save AS SELECT * FROM community_prepared_usage_rows;
CREATE TABLE community_publication_members_0058_save AS SELECT * FROM community_publication_members;
CREATE TABLE telemetry_v1_quota_fit_rows_0058_save AS SELECT * FROM telemetry_v1_quota_fit_rows;
...
DELETE FROM community_publication_members;
DELETE FROM community_prepared_usage_rows;
DELETE FROM community_prepared_usage_bins;
DELETE FROM community_prepared_source_days;
DELETE FROM community_prepared_plan_rows;
DELETE FROM community_prepared_fit_rows;
DELETE FROM community_model_history_work_stage;
DELETE FROM community_model_history_work_parts;
DELETE FROM community_model_history_work;
DELETE FROM community_model_history_results;
DELETE FROM community_model_history_dependencies;
DELETE FROM community_graph_update_scope;
DELETE FROM community_current_analysis_queue;
DELETE FROM community_analysis_work_stage;
DELETE FROM community_analysis_work_parts;
DELETE FROM community_analysis_work;

INSERT INTO participants (id, access_token_id, access_token_hash, recovery_token_id, recovery_token_hash, state, consent_version, consented_at, created_at, deletion_session_id, identity_link_key, identity_cooldown_digest) SELECT id, access_token_id, access_token_hash, recovery_token_id, recovery_token_hash, state, consent_version, consented_at, created_at, deletion_session_id, identity_link_key, identity_cooldown_digest FROM participants_0058_save;
INSERT INTO attribution_enrollments SELECT * FROM attribution_enrollments_0058_save;
INSERT INTO community_aggregate_exclusions SELECT * FROM community_aggregate_exclusions_0058_save;
INSERT INTO community_allowance_fit_cache SELECT * FROM community_allowance_fit_cache_0058_save;
INSERT INTO community_analytical_input_versions SELECT * FROM community_analytical_input_versions_0058_save;
INSERT INTO community_model_composition_cache SELECT * FROM community_model_composition_cache_0058_save;
INSERT INTO contributions SELECT * FROM contributions_0058_save;
INSERT INTO device_credential_rotations SELECT * FROM device_credential_rotations_0058_save;
INSERT INTO device_credentials (id, participant_id, paired_via_pairing_id, secret_hash, state, issued_at, expires_at, last_used_at, revoked_at, social_verified_at, credential_generation) SELECT id, participant_id, paired_via_pairing_id, secret_hash, state, issued_at, expires_at, last_used_at, revoked_at, social_verified_at, credential_generation FROM device_credentials_0058_save;
INSERT INTO device_pairing_events SELECT * FROM device_pairing_events_0058_save;
INSERT INTO device_pairings SELECT * FROM device_pairings_0058_save;
INSERT INTO device_upload_authorizations SELECT * FROM device_upload_authorizations_0058_save;
INSERT INTO enrollment_grants SELECT * FROM enrollment_grants_0058_save;
INSERT INTO participant_community_eligibility SELECT * FROM participant_community_eligibility_0058_save;
INSERT INTO recovery_retry_receipts SELECT * FROM recovery_retry_receipts_0058_save;
INSERT INTO telemetry_contribution_admission_windows SELECT * FROM telemetry_contribution_admission_windows_0058_save;
INSERT INTO telemetry_contribution_occurrences SELECT * FROM telemetry_contribution_occurrences_0058_save;
INSERT INTO telemetry_contributions SELECT * FROM telemetry_contributions_0058_save;
INSERT INTO telemetry_records SELECT * FROM telemetry_records_0058_save;
INSERT INTO telemetry_transport_floor_rollbacks SELECT * FROM telemetry_transport_floor_rollbacks_0058_save;
INSERT INTO telemetry_transport_participant_floors SELECT * FROM telemetry_transport_participant_floors_0058_save;
INSERT INTO telemetry_v11_chunks SELECT * FROM telemetry_v11_chunks_0058_save;
INSERT INTO telemetry_v11_day_manifests SELECT * FROM telemetry_v11_day_manifests_0058_save;
INSERT INTO telemetry_v11_device_consents SELECT * FROM telemetry_v11_device_consents_0058_save;
INSERT INTO telemetry_v11_domain_days SELECT * FROM telemetry_v11_domain_days_0058_save;
INSERT INTO telemetry_v11_domain_heads SELECT * FROM telemetry_v11_domain_heads_0058_save;
INSERT INTO telemetry_v11_domain_predecessors SELECT * FROM telemetry_v11_domain_predecessors_0058_save;
INSERT INTO telemetry_v11_domains SELECT * FROM telemetry_v11_domains_0058_save;
INSERT INTO telemetry_v11_records SELECT * FROM telemetry_v11_records_0058_save;
INSERT INTO telemetry_v1_chunk_admission_windows SELECT * FROM telemetry_v1_chunk_admission_windows_0058_save;
INSERT INTO telemetry_v1_chunks SELECT * FROM telemetry_v1_chunks_0058_save;
INSERT INTO telemetry_v1_device_consents SELECT * FROM telemetry_v1_device_consents_0058_save;
INSERT INTO telemetry_v1_records SELECT * FROM telemetry_v1_records_0058_save;
INSERT INTO upload_authorizations SELECT * FROM upload_authorizations_0058_save;
INSERT INTO web_sessions SELECT * FROM web_sessions_0058_save;

DROP TABLE participants_0058_save;
DROP TABLE attribution_enrollments_0058_save;
DROP TABLE community_aggregate_exclusions_0058_save;
DROP TABLE community_allowance_fit_cache_0058_save;
DROP TABLE community_analytical_input_versions_0058_save;
DROP TABLE community_model_composition_cache_0058_save;
DROP TABLE contributions_0058_save;
DROP TABLE device_credential_rotations_0058_save;
DROP TABLE device_credentials_0058_save;
DROP TABLE device_pairing_events_0058_save;
DROP TABLE device_pairings_0058_save;
DROP TABLE device_upload_authorizations_0058_save;
DROP TABLE enrollment_grants_0058_save;
DROP TABLE participant_community_eligibility_0058_save;
DROP TABLE recovery_retry_receipts_0058_save;
DROP TABLE telemetry_contribution_admission_windows_0058_save;
DROP TABLE telemetry_contribution_occurrences_0058_save;
DROP TABLE telemetry_contributions_0058_save;
DROP TABLE telemetry_records_0058_save;
DROP TABLE telemetry_transport_floor_rollbacks_0058_save;
DROP TABLE telemetry_transport_participant_floors_0058_save;
DROP TABLE telemetry_v11_chunks_0058_save;
DROP TABLE telemetry_v11_day_manifests_0058_save;
DROP TABLE telemetry_v11_device_consents_0058_save;
DROP TABLE telemetry_v11_domain_days_0058_save;
DROP TABLE telemetry_v11_domain_heads_0058_save;
DROP TABLE telemetry_v11_domain_predecessors_0058_save;
DROP TABLE telemetry_v11_domains_0058_save;
DROP TABLE telemetry_v11_records_0058_save;
DROP TABLE telemetry_v1_chunk_admission_windows_0058_save;
DROP TABLE telemetry_v1_chunks_0058_save;
DROP TABLE telemetry_v1_device_consents_0058_save;
DROP TABLE telemetry_v1_records_0058_save;
DROP TABLE upload_authorizations_0058_save;
DROP TABLE web_sessions_0058_save;

INSERT INTO community_analysis_work SELECT * FROM community_analysis_work_0058_save;
INSERT INTO community_analysis_work_parts SELECT * FROM community_analysis_work_parts_0058_save;
INSERT INTO community_analysis_work_stage SELECT * FROM community_analysis_work_stage_0058_save;
INSERT INTO community_current_analysis_queue SELECT * FROM community_current_analysis_queue_0058_save;
INSERT INTO community_graph_update_scope SELECT * FROM community_graph_update_scope_0058_save;
INSERT INTO community_model_history_dependencies SELECT * FROM community_model_history_dependencies_0058_save;
INSERT INTO community_model_history_results SELECT * FROM community_model_history_results_0058_save;
INSERT INTO community_model_history_work SELECT * FROM community_model_history_work_0058_save;
INSERT INTO community_model_history_work_parts SELECT * FROM community_model_history_work_parts_0058_save;
INSERT INTO community_model_history_work_stage SELECT * FROM community_model_history_work_stage_0058_save;
INSERT INTO community_prepared_fit_rows SELECT * FROM community_prepared_fit_rows_0058_save;
INSERT INTO community_prepared_plan_rows SELECT * FROM community_prepared_plan_rows_0058_save;
INSERT INTO community_prepared_source_days SELECT * FROM community_prepared_source_days_0058_save;
INSERT INTO community_prepared_usage_bins SELECT * FROM community_prepared_usage_bins_0058_save;
INSERT INTO community_prepared_usage_rows SELECT * FROM community_prepared_usage_rows_0058_save;
INSERT INTO community_publication_members SELECT * FROM community_publication_members_0058_save;
INSERT INTO telemetry_v1_quota_fit_rows SELECT * FROM telemetry_v1_quota_fit_rows_0058_save;
DROP TABLE community_analysis_work_0058_save;
DROP TABLE community_analysis_work_parts_0058_save;
DROP TABLE community_analysis_work_stage_0058_save;
DROP TABLE community_current_analysis_queue_0058_save;
DROP TABLE community_graph_update_scope_0058_save;
DROP TABLE community_model_history_dependencies_0058_save;
DROP TABLE community_model_history_results_0058_save;
DROP TABLE community_model_history_work_0058_save;
DROP TABLE community_model_history_work_parts_0058_save;
DROP TABLE community_model_history_work_stage_0058_save;
DROP TABLE community_prepared_fit_rows_0058_save;
DROP TABLE community_prepared_plan_rows_0058_save;
DROP TABLE community_prepared_source_days_0058_save;
DROP TABLE community_prepared_usage_bins_0058_save;
DROP TABLE community_prepared_usage_rows_0058_save;
DROP TABLE community_publication_members_0058_save;
DROP TABLE telemetry_v1_quota_fit_rows_0058_save;
