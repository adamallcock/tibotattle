...
This bounded local-only checkpoint is verified. It closes the source-integration and production capability-wiring slice, not G1 as a release and not the end-to-end program. The broader [G1 local-only release route](./2026-07-24-g1-local-release-route.md) and [complete end-to-end goal](./2026-07-24-end-to-end-multi-user-usage-monitor-goal.md) remain active.
