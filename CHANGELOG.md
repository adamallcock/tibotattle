...
- Prepares eligible accountless contributions for the shared public community
  sample, labelled as contribution sources rather than people or verified
  accounts. Existing suppression and withdrawal controls remain in force.
- Preserves accepted contributions across renewable upload expiry and adds
  bounded backfill and exact progress counters. Production migration and
  activation remain separate from these source changes.
