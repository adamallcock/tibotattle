...
| R7 release ceilings | Measured, versioned, enforced heavy-history envelope | `src/export-resource-policy.js`, bounded readers/workspace/verifiers | resource-policy, heap, resume, compression, source-plan tests | Machine-readable full-operation benchmark receipt open |
