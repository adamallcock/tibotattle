...
This verifies the measurement package. It does **not** promote the candidate resource policy. The paired decision receipts correctly return `release_open`; see the [R7 release-ceiling decision](./2026-07-25-g1-r7-release-ceiling-decision.md).
