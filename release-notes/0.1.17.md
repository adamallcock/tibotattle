...
**Status:** Candidate source notes for native dogfood, updated 2026-09-02. RC9
build `1023.7` is allocated on source base
`35802d21ede67d362533f4e2be6b38041ece1cda`; its refresh-policy, current-plan
Trends, and last-good snapshot corrections are under validation. This is not
evidence of a built or installed RC9. Exact-source R7, the complete source gate,
signed/notarized/stapled artifact, state-preserving installation, and physical
verification remain separate requirements. PR #94's real-corpus comparator and
...
RC9 source separates ordinary **Refresh** from **Recalculate detailed
accounting…**. Startup and ordinary refresh update the quota/headline only;
foreground automatic checks may attempt detailed accounting at most hourly
...
source evidence remains unavailable rather than borrowing another plan's fit.
...
Device-pairing continuity remains an open end-to-end gate until the compatible
hosted migrations and Worker deployment are independently verified. A successful
desktop source build or installation is not evidence that pairing works against
the live service.
