...
2. **Make local and receiver vocabularies compatible.** Update canonical
   ...
   schemas, and generated mirrors. Check legacy v0.1/v0.2 and v1.1/v1.2
...
normalization, local plan-era attribution, v0.1 local export and v1.1/v1.2 upload
