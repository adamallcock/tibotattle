...
The detailed Gate C evidence is recorded in [the compressed export-set verification receipt](../receipts/2026-07-24-g1-compressed-export-set-verification-receipt.md).
...
The detailed evidence is recorded in [the local export deletion verification receipt](../receipts/2026-07-24-g1-local-export-deletion-verification-receipt.md). No real user artifact was deleted, transport remains absent, and strict authenticated deletion for incomplete/poisoned workspaces remains a separate future slice.
