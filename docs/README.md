...
Program documentation lives here, grouped by document type. Dated filenames are preserved for traceability.
...
| [`runbooks/`](./runbooks/) | Operator runbooks and handoff notes |
