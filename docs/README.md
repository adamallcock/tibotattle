...
| Electron crash doctor | [Opt-in crash capture and support doctor](./decisions/2026-09-21-opt-in-crash-doctor.md) | Reviewed content-free support projection and off-by-default local macOS Crashpad capture; no dump upload or installed-release claim |
