...
- maintains a separate [coverage gaps register](../governance/2026-07-24-coverage-gaps-register.md) for unobserved, partially observable, and accounting-ambiguous surfaces.
