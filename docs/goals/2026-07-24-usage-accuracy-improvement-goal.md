...
Completed under the evidence-backed accuracy-floor stopping rule. The implementation and frozen results are in `weekly-calibration-v0.2`; the requirement-by-requirement decision is [Usage Prediction Accuracy Floor Decision](../decisions/2026-07-24-usage-accuracy-floor-decision.md).
