...
const PREPARATION_PACKAGE_BYTES = 41;
...
function preparationHandoffBytes() {
  ...
  const prepared = buildWindowsProductionFinalizerPreparationHandoff({
    ...
    package: {
      bytes: PREPARATION_PACKAGE_BYTES,
      name: "app-usagemonitor",
    ...
    source: { ref: WINDOWS_PRODUCTION_AUTHORITY_PROTECTED_REF, revision: REVISION },
    staged: {
      files: [
...
function fixture() {
  ...
  return {
    ...
    preparationHandoffBytes: selectedPreparationHandoffBytes,
