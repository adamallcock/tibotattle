...
**Gate result (2026-07-23): `proceed`.** See [the Milestone 1 decision record](./2026-07-23-milestone-1-transition-miner-decision.md). The fixed live interval yielded 284 transitions, including 177 unit-increase candidates with complete pricing, known model attribution, full elapsed-time coverage, and retained local usage. Two normalized runs were byte-identical. Regressions and unavailable historical snapshot age remain explicit inputs to Milestone 2 rather than being silently removed.
