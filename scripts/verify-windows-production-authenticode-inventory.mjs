 ...
 * checkout/runner paths, certificate subjects/blobs, and raw diagnostics are
 * never emitted.
 */
...
const RECEIPT_FILE_KEYS = Object.freeze(["bytes", "path", "role", "sha256"]);
 ...
 * intentionally projects the certificate SimpleName and timestamp presence;
 * it never serializes SignerCertificate, a distinguished subject, or tool
 * diagnostics.
 */
