export const PORTABLE_TEST_GROUPS = Object.freeze({
  contracts: Object.freeze([
    "test/application-claude-callback-capability.test.js",
    "test/application-quota-sensitivity.test.js",
    "test/accounting-package-boundary.test.js",
    "test/accounting-package-parity.test.js",
    "test/architecture-boundaries.test.js",
    "test/bundle-verification-owner-boundary.test.js",
    "test/contribution-owner-boundary.test.js",
    "test/electron-linux-smoke-contract.test.js",
    "test/electron-windows-smoke-contract.test.js",
    "test/has-exact-enumerable-keys.test.js",
    "test/identity-core-package-boundary.test.js",
    "test/local-export-resource-context.test.js",
    "test/metadata-export-owner-boundary.test.js",
    "test/participant-identity-owner-boundary.test.js",
    ...
    "test/windows-finalizer-source-evidence-selector.test.js",
    "test/windows-production-authority-manifest.test.js",
    "test/windows-production-finalizer-authority.test.js",
    "test/windows-production-finalizer-authority-driver.test.js",
    "test/windows-production-finalizer-authority-input.test.js",
    "test/windows-production-finalizer-preparation-handoff.test.js",
    "test/windows-preparation-manifest-transport.test.js",
    "test/windows-production-finalizer-receipt.test.js",
    "test/windows-production-signed-finalizer-workflow-contract.test.js",
    "test/windows-production-signed-finalizer-workflow.test.js",
    "test/windows-production-finalizer-workflow-contract.test.js",
    "test/windows-production-finalizer-workflow.test.js",
    "test/windows-production-certificate-subject-preflight.test.js",
    "test/windows-production-authenticode-inventory.test.js",
    "test/windows-production-installer.test.js",
    "test/windows-production-packaged-artifact.test.js",
    "test/windows-signing-operation-ledger.test.js",
    "test/windows-native-presign-input-builder.test.js",
  ]),
  ...
  storageAndCompanion: Object.freeze([
    "apps/electron/test/desktop-command.test.mjs",
    "apps/electron/test/desktop-contract.test.mjs",
    "apps/electron/test/desktop-controller.test.mjs",
    "apps/electron/test/desktop-deep-links.test.mjs",
    "apps/electron/test/desktop-first-run.test.mjs",
    "apps/electron/test/desktop-first-run-login.test.mjs",
    "apps/electron/test/desktop-hosted-signin.test.mjs",
    "apps/electron/test/desktop-recovery-settings.test.mjs",
    "apps/electron/test/desktop-ipc.test.mjs",
    "apps/electron/test/desktop-owned-downloads.test.mjs",
    "apps/electron/test/desktop-menu-tray.test.mjs",
    "apps/electron/test/desktop-notification-coordinator.test.mjs",
    "apps/electron/test/desktop-notification-delivery.test.mjs",
    "apps/electron/test/desktop-notification-policy.test.mjs",
    "apps/electron/test/desktop-platform-services.test.mjs",
    "apps/electron/test/desktop-runtime.test.mjs",
    "apps/electron/test/desktop-settings-backends.test.mjs",
    "apps/electron/test/desktop-settings-store.test.mjs",
    "apps/electron/test/desktop-status-monitor.test.mjs",
    "apps/electron/test/desktop-status-tray-runtime.test.mjs",
    "apps/electron/test/desktop-tray-dynamic.test.mjs",
    "apps/electron/test/desktop-tray-status.test.mjs",
    "apps/electron/test/recovery-window.test.mjs",
    "test/desktop-shell-status.test.js",
    "test/electron-protocol-registration.test.js",
    "apps/electron/test/shell-core.test.mjs",
    ...
    "test/contribution-sync-queue-windows.test.js",
    ...
    "test/windows-trusted-signing-pin.test.js",
    "test/windows-wsl-multi-root-qualification.test.js",
  ...
  web: Object.freeze([
    ...
    "apps/web/test/electron-settings.test.mjs",
    "apps/web/test/electron-accessibility.test.mjs",
...
export const WINDOWS_DEFERRED_TESTS = Object.freeze([
  ...
  Object.freeze({
    ...
    reason: "Windows lifecycle fixtures still depend on POSIX owner-mode files and the qualified protected-store composition",
  }),
  Object.freeze({
    file: "test/claude-callback-lifecycle.test.js",
    reason: "Windows lifecycle integration requires qualified protected state and native identity checks; POSIX race fixtures remain portable",
  }),
  Object.freeze({
    file: "test/claude-callback-runtime.test.js",
    reason: "Callback runtime fixtures invoke POSIX shell commands; Windows runner coverage is isolated to explicit Windows contract tests",
  }),
  Object.freeze({
    file: "test/claude-desktop-quota-refresh.test.js",
    reason: "Windows quota state requires the qualified native SQLite and protected-secret stores; POSIX mode fixtures remain portable",
  }),
  Object.freeze({
    file: "test/contribution-device-capability.test.js",
    reason: "Windows contribution state requires a branded native filesystem adapter; POSIX mode and symlink fixtures remain portable",
  }),
  Object.freeze({
    file: "test/contribution-device-renewal.test.js",
    reason: "Windows renewal state requires the qualified protected store; owner-mode assertions remain portable-only",
  }),
  Object.freeze({
    file: "test/electron-package-layout.test.js",
    reason: "The layout suite creates a symlink fixture; Windows hosted runners may require developer-mode privileges",
  }),
  Object.freeze({
    file: "test/local-collector-state-session.test.js",
    reason: "Windows collector state must use the qualified native SQLite session; raw node:sqlite coverage remains portable",
  }),
  Object.freeze({
