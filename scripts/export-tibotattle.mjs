...
export const CLIENT_RUNTIME_FILES = Object.freeze([
  ...
  "src/application/export-sources/claude-config-root.js",
  ...
  "src/platform/local-collector-state-session.js",
  ...
  "src/platform/windows-binding-provenance.js",
  "src/platform/windows-companion-instance-lease.js",
  "src/platform/windows-contribution-sync-queue-storage.js",
  "src/platform/windows-filesystem.js",
  "src/platform/windows-prepared-artifact-storage.js",
  ...
  "src/platform/windows-review-pair-storage.js",
  "src/platform/windows-sqlite-state-session.js",
  "src/platform/windows-sqlite-state-staging.js",
