...
export const CLIENT_RUNTIME_FILES = Object.freeze([
  ...
  "apps/local/work-usage-snapshots.js",
  ...
  "schemas/telemetry-contribution-v1.1/account-plan-attribution.schema.json",
  "schemas/telemetry-contribution-v1.1/contribution.schema.json",
  "schemas/telemetry-contribution-v1.1/day-manifest.schema.json",
  "schemas/telemetry-contribution-v1.1/domain-manifest.schema.json",
  "schemas/telemetry-contribution-v1.1/envelope.schema.json",
  "schemas/telemetry-contribution-v1.1/quota-observation.schema.json",
  "schemas/telemetry-contribution-v1.1/session-dimension.schema.json",
  "schemas/telemetry-contribution-v1.1/usage-event.schema.json",
  "schemas/telemetry-contribution-v1.2/account-plan-attribution.schema.json",
  "schemas/telemetry-contribution-v1.2/contribution.schema.json",
  "schemas/telemetry-contribution-v1.2/day-manifest.schema.json",
  "schemas/telemetry-contribution-v1.2/domain-manifest.schema.json",
  "schemas/telemetry-contribution-v1.2/envelope.schema.json",
  "schemas/telemetry-contribution-v1.2/quota-observation.schema.json",
  "schemas/telemetry-contribution-v1.2/session-dimension.schema.json",
  "schemas/telemetry-contribution-v1.2/usage-event.schema.json",
  "schemas/telemetry-performance-v1/performance-histogram.schema.json",
  "schemas/telemetry-performance-v1/performance-record.schema.json",
  ...
  "src/application/model-performance.js",
  ...
  "src/application/export-sources/claude-transcript-record.js",
  ...
  "src/application/local-contribution-preference.js",
  ...
  "src/application/telemetry-performance-client.js",
  "src/application/telemetry-performance-scheduler.js",
  "src/application/usage-explainer.js",
  "src/application/work-usage.js",
  "src/application/work-usage-snapshots.js",
  "src/automatic-contribution-retirement.js",
  "src/bounded-jsonl.js",
  "src/bundle-verifier.js",
  "src/cache-switch-impact.js",
  "src/claude-desktop-incremental-canonicalizer.js",
  "src/claude-desktop-incremental-refresh.js",
  "src/claude-desktop-ledger-prototype.js",
  "src/claude-desktop-plan-history.js",
  "src/claude-desktop-pricing-cache.js",
  "src/claude-desktop-pricing.js",
  "src/claude-desktop-retention.js",
  "src/claude-desktop-shadow-controller.js",
  "src/claude-desktop-shadow-readiness.js",
  "src/claude-desktop-shadow-refresh.js",
  "src/claude-desktop-shadow-store.js",
  "src/claude-desktop-source-inventory.js",
  "src/claude-statusline-storage.js",
  "src/claude-statusline.js",
  "src/claude-transcript-export-source.js",
  "src/codex-local-usage-analysis.js",
  "src/codex-primary-allowance-basis.js",
  "src/codex-speed-baseline.js",
  "src/codex-transition-miner.js",
  "src/contribution-device-capability.js",
  "src/contribution-accountless-client.js",
  ...
  "src/contribution/performance-daily.js",
  ...
  "src/contribution/telemetry-v12-sync.js",
  "src/contribution/telemetry-performance-sync.js",
  "src/contribution/telemetry-sync-protocol.js",
  "src/contribution/telemetry-v12-chunks.js",
  ...
  "src/local-unified-contribution-v12-evidence-adapter.js",
  "src/local-unified-contribution-v12-evidence.js",
  ...
  "src/platform/bounded-rollout-bytes.js",
  ...
  "src/platform/telemetry-v12-envelope.js",
  "src/platform/validated-snapshot-store.js",
  "src/platform/telemetry-performance-envelope.js",
  ...
  "src/providers/codex/inference-timing.js",
...
export const CLIENT_PACKAGE_FILES = Object.freeze([
  ...
  "packages/telemetry-contract/schemas/performance-v1/performance-histogram.schema.json",
  "packages/telemetry-contract/schemas/performance-v1/performance-record.schema.json",
  ...
  "packages/telemetry-contract/schemas/v1.1/account-plan-attribution.schema.json",
  "packages/telemetry-contract/schemas/v1.1/contribution.schema.json",
  "packages/telemetry-contract/schemas/v1.1/day-manifest.schema.json",
  "packages/telemetry-contract/schemas/v1.1/domain-manifest.schema.json",
  "packages/telemetry-contract/schemas/v1.1/envelope.schema.json",
  "packages/telemetry-contract/schemas/v1.1/quota-observation.schema.json",
  "packages/telemetry-contract/schemas/v1.1/session-dimension.schema.json",
  "packages/telemetry-contract/schemas/v1.1/usage-event.schema.json",
  "packages/telemetry-contract/schemas/v1.2/account-plan-attribution.schema.json",
  "packages/telemetry-contract/schemas/v1.2/contribution.schema.json",
  "packages/telemetry-contract/schemas/v1.2/day-manifest.schema.json",
  "packages/telemetry-contract/schemas/v1.2/domain-manifest.schema.json",
  "packages/telemetry-contract/schemas/v1.2/envelope.schema.json",
  "packages/telemetry-contract/schemas/v1.2/quota-observation.schema.json",
  "packages/telemetry-contract/schemas/v1.2/session-dimension.schema.json",
  "packages/telemetry-contract/schemas/v1.2/usage-event.schema.json",
  ...
  "packages/telemetry-contract/src/performance-histogram.js",
  "packages/telemetry-contract/src/primitives.js",
  "packages/telemetry-contract/src/telemetry-performance-v1-schemas.js",
  "packages/telemetry-contract/src/telemetry-performance-v1.js",
  ...
  "packages/telemetry-contract/src/telemetry-v1.1-schemas.js",
  "packages/telemetry-contract/src/telemetry-v1.1.js",
  "packages/telemetry-contract/src/telemetry-v1.2-domain.js",
  "packages/telemetry-contract/src/telemetry-v1.2-schemas.js",
  "packages/telemetry-contract/src/telemetry-v1.2.js",
...
export const CLIENT_TEST_FILES = Object.freeze([
  ...
  "test/side-chat-estimates.test.js",
