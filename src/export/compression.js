...
function snapshotCompressionLimits(value) {
  ...
  try {
    ...
    throw new TypeError("Compression options could not be read");
  }
}

export function compressExportBytes(value, options = {}) {
  const {
    maximumDecodedBytes,
    maximumEncodedBytes,
  } = snapshotCompressionLimits(options);
...
export function decompressExportBytes(value, options = {}) {
  const {
    maximumEncodedBytes,
    maximumDecodedBytes,
  } = snapshotCompressionLimits(options);
