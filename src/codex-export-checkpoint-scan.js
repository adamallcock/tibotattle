...
import { createEmptyCodexCheckpointState } from "./export-checkpoint-state.js";
...
import { normalizeProviderTier } from "./tier-semantics.js";
import { stableJson } from "./storage.js";
import { ExportWorkspaceError, sourceCheckpointBatchSha256 } from "./export-workspace.js";
import { CODEX_CHECKPOINT_SCAN_VERSION } from "./export-versions.js";

export { CODEX_CHECKPOINT_SCAN_VERSION };
 ...
 */
export async function populateCheckpointedCodexSources({
  workspace,
  sourcePlan,
  secret,
  resourceGuard,
